                ...
                <div className="container mx-auto px-6 flex items-center justify-between">
                    ...
                    <div>
                        ...
                        <div id="menu" className="md:block lg:block hidden">
                            <div onClick="toggleMenu(false)" className="block md:hidden lg:hidden text-gray-500 hover:text-gray-700 focus:text-gray-700 fixed focus:outline-none z-30 top-0 pt-3">
