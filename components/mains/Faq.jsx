        ...
        <section className="max-w-8xl mx-auto container bg-white pt-16">
            <div>
                <div className="flex items-center flex-col px-4">
                    ...
                    <h2 className="text-4xl lg:text-5xl text-center leading-tight text-gray-800 lg:w-7/12 md:w-9/12 pt-4 font-black">Create Beautiful Landing Pages &amp; Web Apps in a Jiffy</h2>
                </div>
                <div className="mt-20 flex flex-wrap justify-between px-4">
                    <div className="flex sm:w-full md:w-5/12 pb-20">
                        <div className="w-20 h-20 relative mr-5">
                            <div className="absolute top-0 right-0 bg-blue-100 rounded-xl w-16 h-16 mt-2 mr-1" />
                            <div className="absolute text-white bottom-0 left-0 bg-blue-600 rounded-xl w-16 h-16 flex items-center justify-center mt-2 mr-3 text-justify">
